...
interface BorderGlowProps {
  ...
  colors?: string[];
  fillOpacity?: number;
  /** Elevation shadow di luar area glow. Default false — matikan jika tidak ingin efek "card melayang". */
  elevated?: boolean;
}
...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  return (
    ...
    >
      {/* mesh gradient border — hanya 1px, menempel di tepi content, bukan frame */}
      <div
      ...
      {/* outer glow — menyebar keluar langsung dari tepi content */}
      <span
      ...
      {/* content wrapper — di-clip mengikuti radius yang sama, tanpa padding */}
